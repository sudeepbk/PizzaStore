  ...
  return (
    <div>
      <Grid container>
        ...
        <Grid container style={{ padding: "20px" }} wrap>
          <Grid item style={{ margin: "10px 10px 10px 10px" }}>
            <Card className={classes.root}>
              ...
              <CardMedia
                ...
                image="https://i.picsum.photos/id/880/200/300.jpg?hmac=dShSJOHRB--zjrqofJOm33xe4Cylybn00N77ewnaS2g"
                title="Paella dish"
              />
              <CardContent>
